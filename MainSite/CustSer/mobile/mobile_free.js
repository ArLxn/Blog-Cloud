		...
		case 6: //客服特别操作及反馈信息
			switch(data.a){
				...
				case 6: //被踢出
					...
					//ip被封禁时返回
					if(data.s == "444"){
						welive.linked = 1; //伪装成已经连接, 不转入留言板
					}
...
function welive_verify(){
	welive.ws.send('x=6&a=8&gid=' + guest.gid + '&fn=' + guest.fn + '&au=' + guest.au + '&aid=' + guest.aid + '&l=' + guest.lang + '&k=' + SYSKEY + '&c=' + SYSCODE + '&fr=' + guest.fromurl.replace(/&/g, "||4||") + '&ag=' + guest.agent + '&ip=' + guest.ip + '&mb=1');
}
...
var welive_op, historyport, sender, msger, smilies_div, shakeobj, alert_info, star_rating;
