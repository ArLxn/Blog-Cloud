...
class c_comments extends Admin{
	...
	public function updatecomments(){
		...
		Success('comments?p=' . $page. FormatUrlParam(array('s'=>urlencode($search), 'g'=>$groupid, 't'=>$time, 'o'=>$order)));
	}
	...
	public function index(){
		...
		if($maxrows['value'] < 1){
			...
			if($totalpages > 1){
				TableRow(GetPageList(BURL('comments'), $totalpages, $page, 10, array('s'=>urlencode($search), 'g'=>$groupid, 't'=>$time, 'o'=>$order)));
			}
		...
		<script type="text/javascript">
			$(function(){
				...
				var url = "' . BURL("comments") . FormatUrlParam(array('p'=>$page, 's'=>urlencode($search), 'g'=>$groupid, 't'=>$time)) . '";
